...
import './ProcessingSucceededIntegrations.css';
...
const ProcessingSucceededIntegrations: React.FC = () => {
  ...
  const deleteItem = (row: IntegrationData) => {
...
export default ProcessingSucceededIntegrations;